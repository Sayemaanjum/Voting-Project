    ...
    <body>
            ...
            <div id="mainSection">
                <div id="profileSection">
                    <center><img src="../votingproject/<?php echo $data['photo']?>" height="100" width="100"></center><br>
                    ...
                    if(isset($_SESSION['groups'])){
                        ...
                        for($i=0; $i<count($groups); $i++){
                            ?>
                                ...
                                <img style="float: right" src="../votingproject/<?php echo $groups[$i]['photo']?>" height="80" width="80">
